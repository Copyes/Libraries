...
let css = [
  ...
  'z-index: 2; -webkit-transform: translate3d(' +
    rem(-148) +
    ', 0, 6px) scale3d(.8, .8, 1); visibility: visible;',
  'z-index: 2; -webkit-transform: translate3d(' +
    rem(148) +
    ', 0, 6px) scale3d(.8, .8, 1); visibility: visible;',
  'z-index: 1; -webkit-transform: translate3d(' +
    rem(-240) +
    ', 0, 2px) scale3d(.667, .667, 1); visibility: visible;',
  'z-index: 1; -webkit-transform: translate3d(' +
    rem(240) +
    ', 0, 2px) scale3d(.667, .667, 1); visibility: visible;'
]
...
class Swiper {
  ...
  init(list) {
    ...
    this.visual = new Array(items.length)
  ...
  touchMoveHandle(e) {
    ...
    this.hasMoved ||
      ((this.hasMoved = 1),
      Math.abs(offsetX) > Math.abs(offsetY) && e.preventDefault())
